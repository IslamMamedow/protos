...
type RegisterRequest struct {
	...
	Email    string `protobuf:"bytes,1,opt,name=email,proto3" json:"email,omitempty"`       // Email to the user register
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"` // Password to the user register
}
...
type LoginRequest struct {
	...
	Password string `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // Password of the user login
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x69, 0x6d, 0x61, 0x6d, 0x65, 0x64, 0x6f, 0x76, 0x2e, 0x73, 0x73, 0x6f, 0x2e, 0x76, 0x31, 0x3b,
